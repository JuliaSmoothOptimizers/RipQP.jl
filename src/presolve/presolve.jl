...
function presolveQM(QM::QuadraticModel{T, S}; uplo = :L) where {T <: Real, S}
  if uplo == :L
    Qm, Qn, Qcolptr, Qrowval, Qnzval =
      sparse_coords(QM.data.Hrows, QM.data.Hcols, QM.data.Hvals, QM.meta.nvar, QM.meta.nvar)
    Am, An, Acolptr, Arowval, Anzval =
      sparse_coords(QM.data.Arows, QM.data.Acols, QM.data.Avals, QM.meta.ncon, QM.meta.nvar)
  else
    Qm, Qn, Qcolptr, Qrowval, Qnzval =
      sparse_coords(QM.data.Hcols, QM.data.Hrows, QM.data.Hvals, QM.meta.nvar, QM.meta.nvar)
    Am, An, Acolptr, Arowval, Anzval =
      sparse_coords(QM.data.Acols, QM.data.Arows, QM.data.Avals, QM.meta.nvar, QM.meta.ncon)
  end
