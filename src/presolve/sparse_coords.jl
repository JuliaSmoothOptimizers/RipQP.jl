...
function sparse_coords(I::AbstractVector{Ti}, J::AbstractVector{Ti}, V::AbstractVector{Tv}, m::Integer, n::Integer, combine) where {Tv,Ti<:Integer}
  ...
  if m == 0 || n == 0 || coolen == 0
      ...
      sparse_coords!(I, J, V, m, n, combine, klasttouch,
              csrrowptr, csrcolval, csrnzval,
              csccolptr, cscrowval, cscnzval)
  end
end

function sparse_coords!(I::AbstractVector{Ti}, J::AbstractVector{Ti},
...
sparse_coords(I::AbstractVector, J::AbstractVector, V::AbstractVector, m::Integer, n::Integer, combine) =
sparse_coords(AbstractVector{Int}(I), AbstractVector{Int}(J), V, m, n, combine)

sparse_coords(I,J,V::AbstractVector) = sparse_coords(I, J, V, SparseArrays.dimlub(I), SparseArrays.dimlub(J))
