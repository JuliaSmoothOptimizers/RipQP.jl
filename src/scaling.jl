...
function post_scale(d1 :: Vector{T}, d2 :: Vector{T}, d3 :: Vector{T}, pt :: point{T}, res :: residuals{T},
    ...
    pt.s_l ./= d2 .* d3
    pt.s_u ./= d2 .* d3
    dual_obj = fd_T0.b' * pt.y - xTQx_2 + view(pt.s_l, id.ilow)'*view(fd_T0.lvar, id.ilow) -
                    view(pt.s_u, id.iupp)'*view(fd_T0.uvar, id.iupp) + fd_T0.c0
    res.rb .= Ax .- fd_T0.b
    res.rc .= ATy .-Qx .+ pt.s_l .- pt.s_u .- fd_T0.c
