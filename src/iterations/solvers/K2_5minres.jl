...
function K2_5minresParams(; preconditioner = :Jacobi, ratol :: T = 1.0e-10, rrtol :: T = 1.0e-10,
                          ρ_min :: T = 1e2 * sqrt(eps()), δ_min :: T = 1e3 * sqrt(eps())) where {T<:Real} 
...
function opK2_5prod!(res::AbstractVector{T}, nvar::Int, Q::AbstractMatrix{T}, D::AbstractVector{T}, 
                     AT::AbstractMatrix{T}, sqrtX1X2::AbstractVector{T}, tmp::AbstractVector{T}, 
                     δv::AbstractVector{T}, v::AbstractVector{T}, α::T, β::T) where T
